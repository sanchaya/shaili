...
import {
  Placeholder, TableRow, TableCell, CheckBox, ButtonGroup, Link,
} from '@adminjs/design-system'
import { ActionJSON, ActionResponse, BasePropertyComponent, RecordActionResponse, RecordJSON, ResourceJSON, useActionResponseHandler, useModal, useTranslation } from 'adminjs';
...
const RecordInList: React.FC<RecordInListProps> = (props) => {
  ...
  const ViewBook = record.recordActions.find(({ name }) => name === 'ViewBook')
  const action = resource.id === 'books' ? ViewBook : (show ? show : edit);
